...
@Component({
  ...
  templateUrl: './market-average-spent-chart.component.html',
  styleUrls: ['./market-average-spent-chart.component.scss']
})
export class MarketAverageSpentChartComponent implements OnInit, OnChanges, OnDestroy {
  ...
  private loadData() {
    ...
    this.subscription = this.receiptService.getMarketAverageSpentStatisticStatisticsMarketAverageSpentGet(
      this.dateFrom,
      this.dateTo,
      ...
      error: err => {
        console.error('Error loading market average spent:', err);
        this.isLoading = false;
